...
export default function Home() {
    return (<>
        ...
        <div className="flex mt-4 mb-8 mx-4 sm:mx-20 md:mx-20">
            <div className="bg-[#fae7ea] text-[#ff4613] p-1 rounded-full cursor-pointer hover:opacity-75 mx-2">
                <div className="flex items-center justify-center">
                    <div className="mx-3 p-1">
                        <RiFireLine size="24" className="p-[1px]" />
                    </div>
                    <div className="mr-4 font-base">
                        <div>Super Deals Product</div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center mx-10">
                <div className="mr-4 font-bold">
                    <div className="text-xl text-[#ff4613]">Womens Wear | Mens Wear</div>
                </div>
            </div>

            <div className="md:flex hidden sm:block items-center justify-center mx-10">
                <div className="mr-4">
        ...
        <div className="my-[50px] sm:my-[72px] mx-4 sm:mx-20 md:mx-20">
            ...
            <div className="mb-[50px] sm:mb-20">
                <ProductListSec title="Brand New  Products" data={topSellingData} viewAllLink="/shop#top-selling" />
            </div>
        </div>
        <FeatureSection />
        <FeatureTWO />
