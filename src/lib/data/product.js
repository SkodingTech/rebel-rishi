export const newArrivalsData = [
    {
        id: 1,
        title: "Women Floral Printed Kurta and Pant Set with Dupatta",
        srcUrl: "/images/product/1.png",
...
export const topSellingData = [
    ...
    {
        id: 94,
        title: "Women Floral Printed Kurt",
        srcUrl: "/images/product/5.png",
        gallery: ["/images/pic2.png"],
        price: 260,
        discount: {
...
export const categories = [
    { id: 1, label: "Men's Clothes" },
    { id: 2, label: "Women's Clothes" },
    { id: 3, label: "Kids Clothes" },
    { id: 4, label: "Bags & Shoes" },
  ];
