...
const TopBanner = () => {
  return (
    ...
    <div className="bg-[#fe4536] text-white text-center py-2 px-2 sm:px-4 xl:px-0 hidden sm:block">
      <div className="flex flex-col sm:flex-row sm:mx-6 md:mx-10 mx-auto relative max-w-frame justify-between items-center xl:px-0 gap-y-2 sm:gap-y-0">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:ml-10 gap-x-4 sm:text-sm text-xs">
        ...
        <div className="flex items-center gap-x-4">
          ...
          <div className="flex items-center cursor-pointer hover:opacity-75">
            ...
            <Link href={"/login"}><div className="text-sm font-semibold">Login</div></Link>
          </div>
