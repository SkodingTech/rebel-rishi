...
const HomeCard = () => {
    ...
    return (
        <>
            <div className="flex justify-center items-center mx-4 sm:mx-10 md:mx-10">


                <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-4 my-4">

                    <div className="flex flex-col sm:flex-row items-center cursor-pointer text-sm hover:scale-105 transition duration-500">
                        <div className="flex items-center p-6 bg-[#fff7ed] shadow-md rounded-2xl">
                    ...
                    <div className="flex flex-col sm:flex-row items-center cursor-pointer text-sm hover:scale-105 transition duration-500">
                        <div className="flex items-center p-6 bg-[#e6eef9] shadow-md rounded-2xl">
                            <div className="bg-white rounded-full p-3"> <HiOutlineTruck size="30" /> </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center cursor-pointer text-sm hover:scale-105 transition duration-500">
                        <div className="flex items-center p-6 bg-[#dff8f6] shadow-md rounded-2xl">
                            <div className="bg-white rounded-full p-3"> <HiOutlineTruck size="30" /> </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center cursor-pointer text-sm hover:scale-105 transition duration-500">
                        <div className="flex items-center p-6 bg-[#ffeef0] shadow-md rounded-2xl">
                            <div className="bg-white rounded-full p-3"> <HiOutlineTruck size="30" /> </div>
