...
const Header = () => {
  return (
    ...
    <section className="mx-4 sm:mx-20 md:mx-20 bg-[#ff4613] shadow-md rounded-3xl text-white p-6 sm:p-10 flex flex-col sm:flex-row justify-between items-center">
      <div className="text-center sm:text-left">
      <p className="text-sm text-white sm:text-base mb-10">Rooted in the rich heritage</p>
